...
public abstract class Funcionario {
    ...
    // Método abstrato para cálculo do salário (será implementado pelas subclasses)
    public abstract double calcularSalario();
    
    // Método abstrato para exibir informações específicas do tipo de funcionário
    public abstract void exibirInformacoes();
}

// Classe abstrata para representar um departamento genérico
